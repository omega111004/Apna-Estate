...
public class PropertyController {
    ...
    public ResponseEntity<Property> createProperty(@Valid @RequestBody Property property) {
        ...
        // New properties should start as PENDING; they will be shown publicly
        // only after an admin approves them via the approval endpoints.
    ...
    public ResponseEntity<?> approveProperty(@PathVariable Long id) {
        ...
        propertyRepository.save(p);
        notificationService.notifyPropertyApproved(p);
        return ResponseEntity.ok(p);
    }
    ...
    public ResponseEntity<?> rejectProperty(@PathVariable Long id) {
        ...
        propertyRepository.save(p);
        notificationService.notifyPropertyRejected(p);
        return ResponseEntity.ok(p);
    }
