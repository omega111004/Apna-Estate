...
public class OtpService {
    ...
    public boolean sendOtp(String email) {
        try {
            ...
            long recentOtpCount = otpTokenRepository.countOtpsByEmailSince(normalizedEmail, rateLimitTime);
            ...
            OtpToken otpToken = new OtpToken(normalizedEmail, otpCode, expiresAt);
            otpTokenRepository.save(otpToken);
            
            // Send email
            sendOtpEmail(normalizedEmail, otpCode, userOpt.get().getFullName());
    ...
    public boolean verifyOtp(String email, String otpCode) {
        try {
            ...
            // Find the OTP
            Optional<OtpToken> otpTokenOpt = otpTokenRepository.findByEmailAndOtpCodeAndUsedFalse(normalizedEmail, otpCode);
    ...
    private void sendOtpEmail(String email, String otpCode, String userName) {
        String subject = "Your Real Estate Login OTP";
        String body = buildOtpEmailContent(userName, otpCode);
        boolean sent = emailService.sendSimpleMessage(email, subject, body);
        if (!sent) {
            System.out.println("Temporary OTP for " + email + ": " + otpCode);
        }
    }
