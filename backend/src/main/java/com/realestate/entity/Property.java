...
public class Property {
    ...
    @Enumerated(EnumType.STRING)
    @Column(nullable = false)
    // New listings start as PENDING and become visible to everyone
    // only after an admin explicitly approves them.
    ...
    public enum PropertyType {
        HOUSE, APARTMENT, CONDO, TOWNHOUSE, VILLA, LAND, FLAT
    }
