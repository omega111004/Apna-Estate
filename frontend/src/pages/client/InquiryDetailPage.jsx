...
import { ArrowLeft, Home, User, Calendar, AlertCircle, Loader2, CheckCircle, IndianRupee } from 'lucide-react';
...
const InquiryDetailPage = () => {
    ...
    const handleInquiryUpdate = (updatedInquiry) => {
        setInquiry(prev => prev ? { ...prev, ...updatedInquiry } : prev);
    };
    const handleGoBack = () => {
        if (user?.role === 'USER') {
            navigate('/inquiries');
    ...
    if (error) {
        ...
        <div className="text-center max-w-md">
          ...
          <button onClick={handleGoBack} className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <button onClick={handleGoBack} className="inline-flex items-center text-gray-600 hover:text-gray-900 mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={handleViewProperty} className="text-blue-600 hover:text-blue-700 text-sm font-medium">
                  View Property
                </button>
              </div>
              
              {inquiry.property.imageUrl && (<img src={inquiry.property.imageUrl} alt={inquiry.property.title} className="w-full h-48 object-cover rounded-lg mb-4"/>)}
              
              <h4 className="font-semibold text-gray-900 mb-2">{inquiry.property.title}</h4>
              
              {inquiry.property.address && (<p className="text-gray-600 text-sm mb-2">
              ...
              {/* Price negotiations */}
              {inquiry.offeredPrice && (<div className="bg-blue-50 rounded-lg p-3 mb-3">
              ...
              {inquiry.agreedPrice && (<div className="bg-green-50 rounded-lg p-3">
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              ...
              <div className="mb-4 pb-4 border-b border-gray-100">
                ...
                {inquiry.client.email && (<div className="text-sm text-gray-600">{inquiry.client.email}</div>)}
                {inquiry.client.phone && (<div className="text-sm text-gray-600">{inquiry.client.phone}</div>)}
              </div>
              ...
              <div>
                ...
                {inquiry.owner.email && (<div className="text-sm text-gray-600">{inquiry.owner.email}</div>)}
                {inquiry.owner.phone && (<div className="text-sm text-gray-600">{inquiry.owner.phone}</div>)}
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              ...
              <div className="space-y-3">
                ...
                {inquiry.status === 'PURCHASED' && (<div className="flex items-start">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-sm border">
              ...
              {inquiry && (<div className="p-6">
                  <ChatComponent inquiryId={inquiry.id} inquiry={inquiry} messages={messages} onMessagesUpdate={handleMessagesUpdate} onInquiryUpdate={handleInquiryUpdate}/>
                </div>)}
            </div>
          </div>
        </div>
