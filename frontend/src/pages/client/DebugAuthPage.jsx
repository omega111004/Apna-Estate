      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="space-y-2 text-sm">
            ...
            {user && (<div>User: {user.firstName} {user.lastName} ({user.role})</div>)}
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="space-y-3">
            <button onClick={debugToken} className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 mr-3">
              Debug Token (Check Console)
            </button>
            
            <button onClick={testNotifications} className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 mr-3">
              Test Notifications API
            </button>
            
            <button onClick={clearStorage} className="px-4 py-2 bg-yellow-600 text-white rounded hover:bg-yellow-700 mr-3">
              Clear Storage & Reload
            </button>
            
            <button onClick={() => { logout(); navigate('/login'); }} className="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 mr-3">
              Logout & Go to Login
            </button>
          </div>
        </div>
