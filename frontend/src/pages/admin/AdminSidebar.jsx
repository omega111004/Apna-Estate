...
const navItemClass = ({ isActive }) => `flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${isActive ? 'bg-primary-100 text-primary-700' : 'text-gray-700 hover:bg-gray-100'}`;
const AdminSidebar = () => {
    return (<aside className="w-60 shrink-0 h-screen sticky top-0 border-r bg-white/90 backdrop-blur">
